...
class Peleador(pygame.sprite.Sprite):
    def __init__(self,imagen1,imagen2,imagen3,imagenGolpe,imagenGolpe2):
        #self.nombre=nombre
        #self.vida=vida
        #self.golpe=golpe
...
def main():
    ...
    imagenGolpe2 = pygame.image.load("imagenes/cody/cody_puno2.png").convert_alpha()
    player1 = Peleador(imagen1,imagen2,imagen3,imagenGolpe,imagenGolpe2)
    vx, vy = 0, 0
    velocidad = 7
    t = 0
